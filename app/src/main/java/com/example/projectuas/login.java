...
public class login extends AppCompatActivity {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status == true){
                        ...
                        storeRegIdinSharedPref(getApplicationContext(), username, email, firstname, lastname);
    ...
    private void storeRegIdinSharedPref(Context context, String username, String email, String firstname, String lastname) {
